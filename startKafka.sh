...
ssh -i $keyfile ubuntu@$master "~/kafka_2.11-0.10.1.1/bin/kafka-server-start.sh ~/kafka_2.11-0.10.1.1/config/server-1.properties &"&
...
for slaveNode in `cat config/slaveNodeList.txt`; do
	...
	ssh -i $keyfile ubuntu@$slaveNode "~/kafka_2.11-0.10.1.1/bin/kafka-server-start.sh ~/kafka_2.11-0.10.1.1/config/server-$configNumber.properties &"&
